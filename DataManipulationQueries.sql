...
-- NOTE: Piazza post @195 states that if we have full participation for 1-M relationship, we can display an error message on the front end in later project steps. Thus, certain deassociations of rows are not possible in my database due to design decisions of my current ER and Schema. The instructor said that this is okay. Please understand, thanks.
